...
class QNTrain(object):
    ...
    def do_training(self, exp_schedule, lr_schedule):
        """
        ...
        while t < self.config.nsteps_train:
            ...
            while True:
                ...
                with torch.no_grad():
                    ...
                    q_vals = q_vals.squeeze().cpu().numpy()
                ...
                if ((t > self.config.learning_start) and (t % self.config.log_freq == 0) and
                   (t % self.config.learning_freq == 0)):
                    ...
                    if len(rewards) > 0:
                        #print(f"QNTrain.do_training.loss_eval: {loss_eval}")
    ...
    def train_step(self, t, replay_buffer, lr):
        ...
        if (t > self.config.learning_start and t % self.config.learning_freq == 0):
            ...
            #print(f"QNTrain.do_training.train_step.loss_eval: {loss_eval}")
    ...
    def run(self, exp_schedule, lr_schedule):
        ...
        # model
        self.do_training(exp_schedule, lr_schedule)
